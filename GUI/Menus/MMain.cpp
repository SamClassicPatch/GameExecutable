...
void CMainMenu::Initialize_t(void) {
  ...
  */
  ...
  gm_lhGadgets.AddTail(gm_mgVersionLabel.n_lnInParent);
  ...
  gm_lhGadgets.AddTail(gm_mgModLabel.n_lnInParent);
  ...
  gm_lhGadgets.AddTail(gm_mgSingle.n_lnInParent);
  ...
  gm_lhGadgets.AddTail(gm_mgNetwork.n_lnInParent);
  ...
  gm_lhGadgets.AddTail(gm_mgSplitScreen.n_lnInParent);
  ...
  gm_lhGadgets.AddTail(gm_mgDemo.n_lnInParent);
  ...
  gm_lhGadgets.AddTail(gm_mgMods.n_lnInParent);
  ...
  gm_lhGadgets.AddTail(gm_mgHighScore.n_lnInParent);
  ...
  gm_lhGadgets.AddTail(gm_mgQuit.n_lnInParent);
