...
void COptionsMenu::Initialize_t(void) {
  ...
  GetChildren().AddTail(gm_mgVideoOptions.n_lnInParent);
  ...
  GetChildren().AddTail(gm_mgAudioOptions.n_lnInParent);
  ...
  GetChildren().AddTail(gm_mgPlayerProfileOptions.n_lnInParent);
  ...
  GetChildren().AddTail(gm_mgNetworkOptions.n_lnInParent);
  ...
  GetChildren().AddTail(gm_mgCustomOptions.n_lnInParent);
  ...
  GetChildren().AddTail(gm_mgAddonOptions.n_lnInParent);
