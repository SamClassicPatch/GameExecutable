...
void CNetworkOpenMenu::Initialize_t(void) {
  ...
  gm_lhGadgets.AddTail(gm_mgAddressLabel.n_lnInParent);
  ...
  gm_lhGadgets.AddTail(gm_mgPort.n_lnInParent);
  ...
  gm_lhGadgets.AddTail(gm_mgJoin.n_lnInParent);
